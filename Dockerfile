...
RUN apt-get install -y python-setuptools python-dev git build-essential default-jre
RUN apt-get install -y libyaml-dev
# PyYAML version must be kept up to date with requirement in https://github.com/seatgeek/sixpack/blob/master/requirements.txt
